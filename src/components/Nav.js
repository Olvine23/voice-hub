                    ...
                    <nav>
                      <ul className="space-y-4">
                        ...
                        <li>
                          <a
                            href="/"
                            classame="inline-flex items-center justify-centegr w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-green-500 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                            aria-label="Sign up"
                            title="Sign up"
                          >
                            Sign up
